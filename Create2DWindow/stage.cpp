...
void initStage(void)
{
	...
	bulletTexture = loadTexture("D:\\game\\gfx\\playerBullet.png");
	enemyTexture = loadTexture("D:\\game\\gfx\\enemy.png");
	alienBulletTexture = loadTexture("D:\\game\\gfx\\alienBullet.png");
	playerTexture = loadTexture("D:\\game\\gfx\\player.png");
	explosionTexture = loadTexture("D:\\game\\gfx\\explode06.png");
	pointsTexture = loadTexture("D:\\game\\gfx\\points.png");
...
static void drawHud(void)
{
	...
	{
		(SCREEN_WIDTH - 10, 10, 0, 255, 0, TEXT_RIGHT, "HIGHSCORE: %03d", stage.score);
	}
}
